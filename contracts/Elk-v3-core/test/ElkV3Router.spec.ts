...
describe('ElkV3Pool', () => {
  ...
  let pool0: MockTimeElkV3Pool
  let pool1: MockTimeElkV3Pool
  ...
  let swapTargetCallee: TestElkV3Callee
  let swapTargetRouter: TestElkV3Router
